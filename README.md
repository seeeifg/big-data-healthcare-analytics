...
This project builds a batch analytics pipeline on the **[MIMIC-III Clinical Database (Demo v1.4)](https://physionet.org/content/mimiciii-demo/1.4/)** using a Docker-based big data environment. It supports structured querying via Hive and parallel analytics using MapReduce.
...
Refer to the file **[Big Data Healthcare Analytics Project - Documentation.pdf](https://github.com/seeeifg/mimiciii-big-data-healthcare-analytics/blob/master/Big%20Data%20Healthcare%20Analytics%20Project%20-%20Documentation.pdf)** for detailed technical architecture, schema design, and analysis overview.
